...
public static class CdpJson
{
    ...
    public static byte[] SerializeCommand(long id, string method, CdpNavigateParameters parameters) =>
        SerializeCommand(id, method, parameters, CdpJsonContext.Default.CdpNavigateParameters);

    public static byte[] SerializeCommand(long id, string method, CdpEvaluateParameters parameters) =>
        SerializeCommand(id, method, parameters, CdpJsonContext.Default.CdpEvaluateParameters);

    public static byte[] SerializeCommand(long id, string method, CdpDeviceMetricsParameters parameters) =>
        SerializeCommand(id, method, parameters, CdpJsonContext.Default.CdpDeviceMetricsParameters);

    public static byte[] SerializeCommand(long id, string method, CdpTouchEmulationParameters parameters) =>
        SerializeCommand(id, method, parameters, CdpJsonContext.Default.CdpTouchEmulationParameters);

    public static byte[] SerializeCommand(long id, string method, CdpDispatchTouchEventParameters parameters) =>
        SerializeCommand(id, method, parameters, CdpJsonContext.Default.CdpDispatchTouchEventParameters);

    public static byte[] SerializeCommand(long id, string method, CdpBackgroundParameters parameters) =>
        SerializeCommand(id, method, parameters, CdpJsonContext.Default.CdpBackgroundParameters);

    public static byte[] SerializeCommand(long id, string method, CdpScreenshotParameters parameters) =>
        SerializeCommand(id, method, parameters, CdpJsonContext.Default.CdpScreenshotParameters);

    public static byte[] SerializeCommand(long id, string method, CdpScreencastParameters parameters) =>
        SerializeCommand(id, method, parameters, CdpJsonContext.Default.CdpScreencastParameters);

    public static byte[] SerializeCommand(long id, string method, CdpScreencastFrameAckParameters parameters) =>
        SerializeCommand(id, method, parameters, CdpJsonContext.Default.CdpScreencastFrameAckParameters);
    ...
    )
    {
        ...
        var command = new CdpCommandModel(id, method, JsonSerializer.SerializeToElement(parameters, parameterTypeInfo));
